...
defmodule SomeEmitter do
  ...
  def ensure_selfgenerator_exists( %SomeEmitter{ selfgenerator: :none,
                                                  element: element,
                                                  state: state } = some ) do
    %{ some |
       selfgenerator: dispatch_generation( element, state ) }
  end
  def ensure_selfgenerator_exists( %SomeEmitter{} = some ) do
    some
  end
  
  defp ensure_restgenerator_exists( %SomeEmitter{
